                                    ...
                                    WC_RNG* rng)
{
    ...
    if (ret == 0) {
        sigsLeft = 0;
        ret      = wh_Client_LmsSigsLeftDma(ctx, key, &sigsLeft);
        if (ret != 0) {
            WH_ERROR_PRINT("Failed LMS SigsLeft after keygen ret=%d\n", ret);
        }
        else if (sigsLeft == 0) {
    ...
    if (ret == 0) {
        ...
        ret      = wh_Client_LmsSigsLeftDma(ctx, key, &sigsLeft);
        if (ret != 0) {
            WH_ERROR_PRINT("Failed LMS SigsLeft after sign ret=%d\n", ret);
        }
        else if (sigsLeft == 0) {
                                     ...
                                     WC_RNG* rng)
{
    ...
    if (ret == 0) {
        sigsLeft = 0;
        ret      = wh_Client_XmssSigsLeftDma(ctx, key, &sigsLeft);
        if (ret != 0) {
            WH_ERROR_PRINT("Failed XMSS SigsLeft after keygen ret=%d\n", ret);
        }
        else if (sigsLeft == 0) {
    ...
    if (ret == 0) {
        ...
        ret      = wh_Client_XmssSigsLeftDma(ctx, key, &sigsLeft);
        if (ret != 0) {
            WH_ERROR_PRINT("Failed XMSS SigsLeft after sign ret=%d\n", ret);
        }
        else if (sigsLeft == 0) {
